...
export default defineSchema({
  ...
  users: defineTable({
    ...
    .index("by_username", ["username"], { unique: true }) // Username lookup for public profiles - UNIQUE
  ...
  features: defineTable({
    icon: v.string(), // Icon name (e.g., "PenTool")
    title: v.string(),
    desc: v.string(),
    color: v.string(), // CSS gradient classes
  }),

  socialProofStats: defineTable({
    metric: v.string(),
    label: v.string(),
