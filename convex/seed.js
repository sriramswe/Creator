...
export const seed = mutation({
  ...
  handler: async (ctx) => {
    ...
    const user3 = await ctx.db.insert("users", {
      ...
      imageUrl: "https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?auto=format&fit=crop&w=200&q=80",
      username: "charlieb",
      createdAt: Date.now(),
      lastActiveAt: Date.now(),
    });
    ...
    const post1 = await ctx.db.insert("posts", {
      ...
      category: "Technology",
      featuredImage: "https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=1200&q=80",
      createdAt: Date.now(),
      updatedAt: Date.now(),
    ...
    const post2 = await ctx.db.insert("posts", {
      ...
      category: "Marketing",
      featuredImage: "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=1200&q=80",
    ...
    const post3 = await ctx.db.insert("posts", {
      ...
      featuredImage: "https://images.unsplash.com/photo-1481277542470-605612bd2d61?auto=format&fit=crop&w=1200&q=80",
